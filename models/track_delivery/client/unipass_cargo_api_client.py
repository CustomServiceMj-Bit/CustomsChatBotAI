...
from models.track_delivery.parser.unipass_xml_parser import parse_progress
from models.common.error_codes import (
    FETCH_ERROR_MESSAGE,
    INVALID_CARGO_NUMBER_MESSAGE,
    INVALID_BL_NUMBER_MESSAGE,
    NO_PROGRESS_INFO_MESSAGE,
)
from models.track_delivery.api_spec.unipass_api_spec import (
    PARAM_API_KEY,
    PARAM_CARGO_NO,
    PARAM_HBL_NO,
    PARAM_MBL_NO,
...
class UnipassCargoApiClient:
    ...
    def get_cargo_progress_details(self, cargo_mt_no: str) -> CargoProgressResult:
